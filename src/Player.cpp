...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    void Player::resolveCollisionNitem(Nitem& nitem) {
    if (getBounds().intersects(nitem.getBounds())) {
        // Aquí es donde se disminuye el contador de ítems en el Subject
        Subject* subject = getSubject(); // Obtén el Subject asociado (necesitas tener una forma de obtenerlo)
        if (subject) {
            subject->addItem(); // Disminuye el contador de ítems
        }
        // Opcional: manejar la destrucción del Nitem si es necesario
    }
}
