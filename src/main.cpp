...
int main() {
    ...
    if (!itemTexture.loadFromFile("/Users/HP/Desktop/Unite/images/spritesheet(1).png")) {
        return -1;
    }
    sf::Texture nitemTexture;
    if (!nitemTexture.loadFromFile("/Users/HP/Desktop/Unite/images/skull.png")) {
        return -1;
    }


    sf::Font font;
    if (!font.loadFromFile("/Users/HP/Desktop/Unite/images/Retro Gaming.ttf")) {
        return -1;
    }

    sf::Texture fireballTexture;
    if (!fireballTexture.loadFromFile("/Users/HP/Desktop/Unite/images/Fireball Spritesheet.png")) {
        return -1;
    }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Player player1("/Users/HP/Desktop/Unite/images/AnimationSheetderecha.png", "/Users/HP/Desktop/Unite/images/AnimationSheetizq.png", sf::Vector2f(100.0f, 0.0f), 1 ,player1Name, font);
    Player player2("/Users/HP/Desktop/Unite/images/AnimationSheetderecha.png", "/Users/HP/Desktop/Unite/images/AnimationSheetizq.png", sf::Vector2f(600.0f, 400.0f), 2 ,player2Name, font);
    ...
    ItemFactory::createNitems(nitemTexture, nitems, itemWidth, itemHeight, numItems, level.getPlatforms(), itemScale);
    ...
    while (window.isOpen()) {
        ...
        if(gameState == PLAYING){
            ...
            for (auto& nitem : nitems) {
                ...
                window.draw(nitem.getSprite()); // O similar si usas otro método para dibujar

                // Manejar colisiones entre el jugador y los Nitems
                if (player.isColliding(nitem.getBounds())) {
                    // Disminuir el contador de ítems en Subject
                    subject.setItem(subject.getItem() - 1);

                    // Opcionalmente, eliminar el Nitem si es necesario
                    nitems.erase(std::remove(nitems.begin(), nitems.end(), nitem), nitems.end());
                }
            }
